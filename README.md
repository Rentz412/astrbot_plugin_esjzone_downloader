...
- 查看插件名称、版本、作者和仓库链接。
- 支持亮色 / 深色主题切换，选择记忆在浏览器本地，首次打开默认深色。
- 查看统计概览：
  - 已保存登录态用户数量
  - 本地小说数量
  - 插件数据目录占用空间
...
本插件代码由 ChatGPT 5.5 与 Claude-opus-4.7/4.8 辅助完成，并依据 AstrBot 插件开发文档和本项目规格书进行整理与实现。
